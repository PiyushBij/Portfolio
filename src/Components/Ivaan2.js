...
<section id="top" className="eparent-e1">
    <div className="home-e1">
        ...
        className="i2-image"></div>
        <div className="e1-heading-container">
            <h1>Ivaan Studios II</h1>
            <h3><i>A Studio With Creative Developers.</i></h3>
        </div>
        <div className="e1-role">
            <div className="roles"><span className="ivaan-color">Role</span>  Full stack developer</div>
            <div className="roles"><span className="ivaan-color">Context</span>  Full Website design</div>
            <div className="roles"><span className="ivaan-color">Period</span>  may 2022</div>
        </div>
    </div>
